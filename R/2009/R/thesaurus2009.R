...
fichier_thesaurus_txt = "../TXT/thesaurus_2009.txt"
fichier_mol_seules_csv = "../CSV/mol_thesaurus_seules2009.csv"
fichier_mol_famille_csv = "../CSV/mol_famille_thesaurus2009.csv"
...
test$remove_entrees(nom_entree = "ANTICANCEREUX ET INR")
test$remove_entrees(nom_entree = "ECG.")
test$verif_entrees2()
...
thesaurus2009 <- test
save(thesaurus2009, file="../../../data/thesaurus2009.rdata")