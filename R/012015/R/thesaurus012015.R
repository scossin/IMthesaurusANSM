...
fichier_thesaurus_txt = "../TXT/thesaurus_012015.txt"
fichier_mol_seules_csv = "../CSV/mol_thesaurus_seules012015.csv"
fichier_mol_famille_csv = "../CSV/mol_famille_thesaurus012015.csv"
...
thesaurus012015 <- test
save(thesaurus012015, file="../../../data/thesaurus012015.rdata")
