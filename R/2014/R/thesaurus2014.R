...
fichier_thesaurus_txt = "../TXT/thesaurus_2014.txt"
fichier_mol_seules_csv = "../CSV/mol_thesaurus_seules2014.csv"
fichier_mol_famille_csv = "../CSV/mol_famille_thesaurus2014.csv"
...
thesaurus2014 <- test
save(thesaurus2014, file="../../../data/thesaurus2014.rdata")