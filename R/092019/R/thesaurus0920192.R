...
fichier_thesaurus_txt = "../TXT/thesaurus_092019.txt"
fichier_mol_seules_csv = "../CSV/mol_thesaurus_seules092019.csv"
fichier_mol_famille_csv = "../CSV/mol_famille_thesaurus092019.csv"
...
test$remove_entrees(nom_entree = "ANTI-INFECTIEUX ET HEMOSTASE")
test$verif_entrees2()
...
thesaurus092019 <- test
save(thesaurus092019, file="../../../data/thesaurus092019.rdata")

df <- thesaurus092019$df
