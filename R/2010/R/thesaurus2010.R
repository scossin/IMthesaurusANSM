...
fichier_thesaurus_txt = "../TXT/thesaurus_2010.txt"
fichier_mol_seules_csv = "../CSV/mol_thesaurus_seules2010.csv"
fichier_mol_famille_csv = "../CSV/mol_famille_thesaurus2010.csv"
...
thesaurus2010 <- test
save(thesaurus2010, file="../../../data/thesaurus2010.rdata")
