...
fichier_thesaurus_txt = "../TXT/thesaurus_032012.txt"
fichier_mol_seules_csv = "../CSV/mol_thesaurus_seules032012.csv"
fichier_mol_famille_csv = "../CSV/mol_famille_thesaurus032012.csv"
...
thesaurus032012 <- test
save(thesaurus032012, file="../../../data/thesaurus032012.rdata")