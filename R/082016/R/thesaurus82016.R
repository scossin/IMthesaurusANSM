...
fichier_thesaurus_txt = "../TXT/thesaurus_82016.txt"
fichier_mol_seules_csv = "../CSV/mol_thesaurus_seules82016.csv"
fichier_mol_famille_csv = "../CSV/mol_famille_thesaurus82016.csv"
...
thesaurus82016 <- test
save(thesaurus82016, file="../../../data/thesaurus82016.rdata")
